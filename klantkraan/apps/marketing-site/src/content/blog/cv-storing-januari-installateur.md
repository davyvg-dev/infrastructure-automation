---
title: 'CV-storing in januari: waarom 62% van uw klanten u niet bereikt'
description: 'Wat een CV-monteur in januari verliest aan gemiste oproepen, en hoe een Nederlandstalige AI-telefoniste pieken vangt zonder voicemail-trap.'
pubDate: 2026-05-20
author: 'Klantkraan'
vertical: 'installateur'
keywords:
  - 'cv-storing januari'
  - 'ai telefoniste installateur'
  - 'cv-monteur gemiste oproepen'
  - 'vorstpieken installateur'
  - 'gemiste klanten cv-storing'
---

Een woensdagochtend in januari. Het heeft 's nachts gevroren. Drie klanten bellen u binnen veertig minuten met dezelfde melding: de CV doet niets meer, het is acht graden binnen, de kinderen moeten naar school.

U zit bij klant nummer één in de meterkast. Klant twee krijgt de bezetkleur. Klant drie krijgt voicemail en belt direct uw concurrent.

Dit artikel rekent eerlijk door wat dat per CV-monteur per jaar kost — en wat een AI-telefoniste er in de praktijk aan doet. Geen verkooppraatje, wel cijfers en grenzen.
...
Twee januari-weken kost u in dat scenario €3.400 — en dat is voordat u de reputatie-schade meeneemt: een klant die u niet bereikt op het moment dat hij u écht nodig heeft, vertelt zijn buren over uw concurrent.
...
1. **48%** belt direct de volgende leverancier op de Google-pagina. Géén voicemail.
2. **27%** spreekt een voicemail in, wacht 20 minuten, en belt dan alsnog door.
3. **15%** stuurt later een WhatsApp of e-mail — niet diezelfde dag opgelost.
4. **10%** zoekt een uur later opnieuw, vaak via een andere zoekterm.

Voor een spoed-CV-storing in januari is dat scenario (1) bijna gegarandeerd. Een huiseigenaar zonder warm water gaat niet wachten. Hij gaat tien minuten verder zoeken — en in een grote stad zijn er twintig CV-monteurs binnen vijf kilometer.

Voicemail is geen oplossing. Een antwoordservice (€2,50–€4 per gesprek, vaste lijn-prijs en commitment per maand) helpt iets, maar mist de spraakkwaliteit en kent uw tarieven niet. De klant hoort iemand zeggen "we noteren uw nummer en bellen u terug" — en de meeste klanten hebben dat al opgehangen voordat de zin af is.
...
- **Hij installeert niet zelf.** Geen verrassing — maar voor alle duidelijkheid: een AI-telefoniste vervangt geen monteur. Hij vangt de communicatie, niet het werk.
...
Eerlijk advies: als u onder de 10 oproepen per week zit, of als u alle inkomende oproepen al persoonlijk aanneemt zonder pieken, of als uw klant-base uit één grote zorgaanbieder bestaat met vaste planning — dan is Klantkraan overkill. Bij die volume- en klantprofiel is een normale agenda + voicemail-routine voldoende.
