...
- [ ] **Draft 5 Dutch utility templates** (offerte-opvolging ×2, afspraakherinnering, reviewverzoek, factuurherinnering) — generic, variable slots, reusable across all clients. Written as transaction status, never an offer: that is the €0.03 utility band vs the €0.16 marketing band. Submit the moment the sender exists.
