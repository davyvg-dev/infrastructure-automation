...
- [~] **Phase 1 — Home** (serial): 1.1 NL `index.astro` rebuilt (faf1e29) + 1.2 web-design-guidelines fixes (cd83615) + 1.3 **founder APPROVED 2026-07-23** DONE. **NEXT = 1.4 EN/ES home twins → 1.5 first preview deploy (`--branch=redesign`).** ■
