...
> One-liners. Direct. No "I hear you" preamble (Dutch buyers find it patronising). Aim to reframe the question in one sentence and reclose.
...
> "Onboarding = 1 telefoongesprek van 20 minuten. Ik doe de rest. Jij doet letterlijk niets, behalve aan het einde een paar testbelletjes."

→ This is the highest-frequency real objection. Hammer the 2h reality.

### 6. "Mijn telefonist / partner doet dit al"
...
### 8. "Wat doe je met mijn klantgegevens?"

> "Servers in Frankfurt (Hetzner EU), data versleuteld, verwerkersovereenkomst standaard bij contract. Niets verlaat de EU. Bij opzegging krijg je een export en wis ik de data binnen 30 dagen."
...
- ❌ "Ik begrijp je twijfel." (Dutch reads as condescending.)
- ❌ "Veel van mijn klanten zeggen hetzelfde." (Sounds like a script.)
- ❌ "Trust me." (Earn trust by referencing KvK + DPA + concrete cases.)
- ❌ "Maak je geen zorgen." (Dismissive.)
- ❌ Anglicismen ("scalable", "no-brainer", "ROI"). Use Dutch equivalents.

## Track which objections show up

Log every discovery call in Attio with the top objection encountered. Friday KPI review: which objection trended this week. Update sales materials accordingly.

## Source

- Hofstede NL low-masculinity, direct-communication: https://internationalbusinesscenter.org/geert-hofstede/hofstede_netherlands.shtml
- Dutch B2B sales benchmarks (Optifai 939 companies): https://optif.ai/learn/
- Anti-pattern: US sales scripts translated literally — Belkins outreach study notes 4× reply rate when localized: https://www.belkins.io/blog/linkedin-outreach-study
