...
If we don't have a DPA signed *before* go-live, every call recording, every caller phone number, every transcript is an unlawful processing under art. 28(3) AVG. AP can impose corrective measures + fines up to €20M / 4% turnover (art. 83 AVG).
