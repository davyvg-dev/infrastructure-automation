...
- Vraag de pilot-klant of ze ook met naam genoemd willen worden. Zo ja → DM cadans wijzigt naar "een persoonlijke shoutout".
- Hook test (nu nog placeholder): "[X] calls in 30 dagen. [Y] daarvan zou hij gemist hebben." — bewijs vóór ego.
- Cadans: voor/na, in cijfers. Geen "we hebben hun leven veranderd".

## Post body (kopieer dit naar LinkedIn — na pilot #1, 30 dagen data)

30 dagen geleden zette een loodgieter in de Randstad zijn telefoon door naar Klantkraan.
...
Wat hem het meest verbaasde (zijn quote, parafraseerd):
...
Ik zoek nog [N] loodgieters voor maand 2-pilot. Eerste maand 50% korting. DM open.

#loodgieter #dakdekker #ondernemen

## Eerste comment (kopieer dit als eerste reactie op je eigen post)

Volledig pilot-rapport (geanonimiseerd) als PDF: klantkraan.nl — DM voor een kopie.
