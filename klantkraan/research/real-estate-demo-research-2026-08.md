...
Key asymmetry everywhere: agencies _feed listings in_ to portals (Idealista ILC JSON/XML etc.); almost nobody gets to _read the market out_. Resales Online is the exception because it's an MLS, not a portal.
